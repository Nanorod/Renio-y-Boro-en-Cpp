...
{
    char nombre[20];
    int comentarios, ancho, alto, grises;
...
void recubrimiento(IMAGEN *imagen)
{
    ...
    porce = (pix1/tam1)*100;
    //porcentaje = (contar/(imagen->alto*imagen->ancho))*100;
    printf("CONTAR: %d \n", contar);
    printf("TAMAÑO: %d \n", tam);
    printf("PIXELES: %d \n", pix);
    printf("PORCE: %.2f ", porce);
    printf("%c\n", '%');
    ...
    printf("ALTO: %d \n",imagen->alto);
    printf("ANCHO: %d \n",imagen->ancho);
    //tamaño = (imagen->alto*imagen->ancho);
    //pix = tamaño - contar;
    //printf("PIX: %d \n",pix);
    //porcentaje = ((pix/tamaño)*100);
    //printf("PORCENTAJE: %d \n",porcentaje);
    tam = imagen->alto*imagen->ancho;
    printf("TAMAÑO: %d \n", tam);
*/
